...
export const useTeamAttendances = (
    ...
    const [attendancesByUser, setAttendancesByUser] = useState<
        {
            agent_roster: number
            name: string
        ...
        attendanceApi
            ...
            .then(res => {
                const result = users.map(agent => ({
                    ...
                    fechas: res.data
                        .filter(
                            (r: { agent_roster: number }) => r.agent_roster === agent.agent_roster,
                        )
    ...
    const handleAttendanceChange = useCallback(
        (agent_roster: number, date: string, value: string) => {
